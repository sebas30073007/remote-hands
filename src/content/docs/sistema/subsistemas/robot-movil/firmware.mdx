...
<figure>
  <img
    src="/remote-hands/images/build/controlador-cl57t-placa.webp"
...
[Servidor / percepción](/remote-hands/sistema/subsistemas/servidor-percepcion/).
...
| --- | --- | --- | --- |
| [Puente H](/remote-hands/sistema/subsistemas/robot-movil/electronica/) | Diseño propio (KiCad) | USB-CDC COM4 (maestro) | Motores DC de tracción |
| [CL57T](/remote-hands/sistema/subsistemas/robot-movil/controladores/cl57t/) | Diseño propio (KiCad) | I²C `0x0B` vía maestro | 3 ejes del manipulador |
| [Gripper](/remote-hands/sistema/subsistemas/robot-movil/controladores/gripper/) | Protoboard (sin PCB) | USB-CDC COM5 | Pinza — posición en mm |
...
[Electrónica](/remote-hands/sistema/subsistemas/robot-movil/electronica/#modos-de-operación-dip-switch);
...
[Middleware](/remote-hands/sistema/subsistemas/servidor-percepcion/middleware/).
